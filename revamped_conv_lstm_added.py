  ...
  with tf.Graph().as_default():
   ...
   # training
    ...
    for step in xrange(FLAGS.max_step):
      ...
      if step%200 == 9:
        ...
        for i in range(len(x_dev)/16):
            ...
            accuracy = sess.run(tf_accuracy, feed_dict={x:dev_features, y:dev_labels, keep_prob:FLAGS.keep_prob})
    ...
    for i in range(len(x_test)/16):
        ...
        accuracy = sess.run(tf_accuracy, feed_dict={x:test_features, y:test_labels, keep_prob:FLAGS.keep_prob})
